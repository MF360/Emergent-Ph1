    ...
    <section className="relative w-full min-h-screen py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          Transform your distribution business with MF360. Manage clients,
          analyze portfolios, and execute transactions seamlessly—all powered by
          AI-driven insights.
        </p>
            ...
            <div className="flex items-center justify-between p-4 border-b border-border">
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  ...
                  <div className="h-8 w-8 rounded-full bg-muted/40 border-2 border-card flex items-center justify-center text-xs text-foreground">
                    +3
                  </div>
                </div>
